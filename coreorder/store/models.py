...
TAST_TYPE = (
    ...
    ("THESIS/THESIS CHAPTER", "THESIS/THESIS CHAPTER"),
    ...
    ("APPLICATION PAPER", "APPLICATION PAPER"),
    ...
    ("EXTENDED REVISION", "EXTENDED REVISION"),

    ("MICROSOFT PROJECT", "MICROSOFT PROJECT"),

    ("PROGRESSIVE PAPER", "PROGRESSIVE PAPER"),
    ...
    ("NURSING CALCULATIONS", "NURSING CALCULATIONS"),
