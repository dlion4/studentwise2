...
class UserProfile(models.Model):
    ...
    profilepic = models.ImageField(null=True, blank=True, upload_to="account/profile/")
...
post_save.connect(post_save_userprofile_model_receiver, sender= settings.AUTH_USER_MODEL)